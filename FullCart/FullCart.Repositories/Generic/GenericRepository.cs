...
namespace FullCart.Repositories.Generic
{
    public class GenericRepository<T> : IGenericRepository<T> where T : BaseEntity
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<T> GetMinimumAsync(bool withDeleted = false)
        {
            var min = await _dbContext.Set<T>().MinAsync();
            if (!withDeleted)
                min = await _dbContext.Set<T>().Where(x => !x.IsDeleted).MinAsync();
        ...
        /// <param name="selector"></param>
        /// <returns></returns>
        public async Task<object> GetMinimumAsync(Expression<Func<T, object>> selector, bool withDeleted = false)
        {
            var min = await _dbContext.Set<T>().MinAsync(selector);
            if (!withDeleted)
                min = await _dbContext.Set<T>().Where(x => !x.IsDeleted).MinAsync(selector);
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<T> GetMaximumAsync(bool withDeleted = false)
        {
            var max = await _dbContext.Set<T>().MaxAsync();
            if (!withDeleted)
                max = await _dbContext.Set<T>().Where(x => !x.IsDeleted).MaxAsync();
        ...
        /// <param name="selector"></param>
        /// <returns></returns>
        public async Task<object> GetMaximumAsync(Expression<Func<T, object>> selector, bool withDeleted = false)
        {
            var max = await _dbContext.Set<T>().MaxAsync(selector);
            if (!withDeleted)
                max = await _dbContext.Set<T>().Where(x => !x.IsDeleted).MaxAsync(selector);
        ...
        public IQueryable<T> GetAllIncluding(bool withDeleted = false, params Expression<Func<T, object>>[] includeProperties)
        {
        ...
        {
            IQueryable<T> queryable = GetAll(withDeleted).AsNoTracking().Where(where);
            foreach (Expression<Func<T, object>> includeProperty in includeProperties)
                queryable = queryable.Include(includeProperty);
        ...
        /// <param name="includeProperties"></param>
        /// <returns></returns>
        public async Task<IQueryable<T>> GetAllIncludingAsync(bool withDeleted = false, params Expression<Func<T, object>>[] includeProperties)
        {
        ...
        private PaginatedList<T> Paginate<TKey>(int pageIndex, int pageSize, Expression<Func<T, TKey>> keySelector, Expression<Func<T, bool>>? predicate, OrderByType orderByType, bool withDeleted = false, params Expression<Func<T, object>>[] includeProperties)
        {

            IQueryable<T> queryable =
                (orderByType == OrderByType.Ascending)
                    ? GetAllIncluding(withDeleted, includeProperties).AsQueryable().OrderBy(keySelector)
                    : GetAllIncluding(withDeleted, includeProperties).AsQueryable().OrderByDescending(keySelector);

            queryable = (predicate != null) ? queryable.Where(predicate) : queryable;
            PaginatedList<T> paginatedList = new PaginatedList<T>(); //queryable.ToPaginatedList(pageIndex, pageSize);
        ...
        /// <param name="keySelector"></param>
        /// <returns></returns>
        public PaginatedList<T> Paginate<TKey>(int pageIndex, int pageSize, Expression<Func<T, TKey>> keySelector, bool withDeleted = false)
        {
            return Paginate<TKey>(pageIndex, pageSize, keySelector, null, withDeleted);
        }
        ...
        /// <param name="includeProperties"></param>
        /// <returns></returns>
        public PaginatedList<T> Paginate<TKey>(int pageIndex, int pageSize, Expression<Func<T, TKey>> keySelector, Expression<Func<T, bool>>? predicate, bool withDeleted = false, params Expression<Func<T, object>>[] includeProperties)
        {

            PaginatedList<T> paginatedList = Paginate<TKey>(
                pageIndex, pageSize, keySelector, predicate, OrderByType.Ascending, withDeleted, includeProperties);
        ...
        /// <param name="keySelector"></param>
        /// <returns></returns>
        public PaginatedList<T> PaginateDescending<TKey>(int pageIndex, int pageSize, Expression<Func<T, TKey>> keySelector, bool withDeleted = false)
        {
            return PaginateDescending<TKey>(pageIndex, pageSize, keySelector, null, withDeleted);
        }
        ...
        /// <param name="includeProperties"></param>
        /// <returns></returns>
        public PaginatedList<T> PaginateDescending<TKey>(int pageIndex, int pageSize, Expression<Func<T, TKey>> keySelector, Expression<Func<T, bool>>? predicate, bool withDeleted = false, params Expression<Func<T, object>>[] includeProperties)
        {
            PaginatedList<T> paginatedList = Paginate<TKey>(
                pageIndex, pageSize, keySelector, predicate, OrderByType.Descending, withDeleted, includeProperties);
        ...
        {
            if (property.Body is not MemberExpression memberExpression || memberExpression.Member is not PropertyInfo)
            {
